...
-- 3. BANK 테이블의 BANK_NAME 컬럼을 NOT NULL 처리한다.
ALTER TABLE BANK MODIFY BANK_NAME VARCHAR2(10) NOT NULL;

-- 4. CUSTOMER 테이블의 NAME 칼럼을 NULL 처리한다.     수정할 때는 NULL 넣기, 생략안됨 
ALTER TABLE CUSTOMER MODIFY NAME VARCHAR2(20) NULL;

-- 5. CUSTOMER 테이블의 NAME 칼럼을 CUSTOMER_NAME로 수정한다.
