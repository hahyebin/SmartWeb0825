...
ALTER TABLE schedule ADD CONSTRAINT schedule_nation_fk FOREIGN KEY(n_code) REFERENCES nation(n_code);
ALTER TABLE schedule ADD CONSTRAINT schedule_event_fk FOREIGN KEY(e_code) REFERENCES event(e_code);
