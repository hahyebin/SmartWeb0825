...
CREATE TABLE STUDENT(
     STUDENT_NO    NUMBER(5),    -- 타입은 정수 5자리(MAX) 
...
-- M:N 관계
-- 학생(M) : 과목(N) 관계 -> 테이블2개는 물리적 구현 불가
-- 학생 - 수강신청 - 과목 : 테이블 3개로 구현가능


DROP TABLE ENROLL;   --자식 삭제
DROP TABLE STUDENT;  --부모 삭제
DROP TABLE SUBJECT;  --부모 삭제
