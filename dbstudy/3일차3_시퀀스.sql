...
INSERT INTO employee VALUES(employee_seq.nextval, '구창만', 1, '과장','M','95-05-01',5000000);
...
INSERT INTO employee VALUES(employee_seq.nextval, '연습용',2,'과장','M','97-11-01',3000000);
...
--dual 테이블에서 가져온다는 뜻이 아님 아님


SELECT employee_seq.currval FROM DUAL;
SELECT employee_seq.nextval FROM DUAL;  -- 단순히 확인 아니고 값은 늘어나기 때문에 확인 후 INSERT 넣으면 연속 값이 아니라 한단계 건너뛰어 값 입력됨
