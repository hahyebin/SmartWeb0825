...
public class EmpDao {
	...
	// 0. 사용할 매퍼의 namespace 저장하기(중복되기 때문에 변수 처리 )
	...
	public int deleteEmp(Long num) {
		...
		// 1) SqlSession 객체 생성 
		//		DML(insert, update, delete) 은 수행후 commit()이 필요하다
	...
	public int UpdateEmp(EmpDto empDto) {
		...
		SqlSession ss = factory.openSession(false);   // false는 commit()하고 싶어서
