package com.koreait.video.repository;
 ...
 **/
	...
	public List<Video> selectGalleryList();		// 목록보기 쿼리
	public Video selectGalleryByNo(Long no);      // 상세보기 쿼리
	public int insertGallery(Video gallery);      // 등록하기 쿼리
	public int updateGallery(Video gallery);      // 수정하기 쿼리
