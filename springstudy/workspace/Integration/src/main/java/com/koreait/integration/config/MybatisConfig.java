...
public class MybatisConfig {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mapper/*.xml"));   // setMapperLocations의 매개변수는 String이 아님 때문에 파일경로를 적기 위해서 새로운 클래스를 생성해서 만든다.
